...
# 项目内部模块
# ===========================
from config import TOKEN, KEYWORDS, ADMIN_IDS, DATA_DIR, ADMIN_USERNAMES, LOGS_PER_PAGE, BEIJING_TZ, build_and_send_logs
...
async def send_welcome(update_or_msg, name):
    welcome_text = (
        ...
        "5️⃣ 输入指令/remind或从Menu选择，开启提醒功能，每天提醒你打卡；\n\n"
        "IP截图必须包含以下信息\n"
        "① 设备编码：本机序列号\n"
        "② 实时IP：指定网站内显示的IP\n"
